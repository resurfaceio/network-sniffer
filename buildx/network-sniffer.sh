...
docker buildx build --builder multiremote --push -t resurfaceio/${CUSTOM_BUILDX_IMAGE_NAME:-network-sniffer}:$1 --build-arg GORVER=$2 --platform linux/amd64,linux/arm64 -f "${CUSTOM_BUILDX_DOCKERFILE:-Dockerfile}" .
